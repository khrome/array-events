import * as asyncarrays from 'async-arrays/async-arrays.mjs';
import { Emitter as emitter } from 'extended-emitter-es6';
...
export class EventedArray{
    constructor(progenitor, wrap){
...
//const ArrayEvents = EventedArray;
